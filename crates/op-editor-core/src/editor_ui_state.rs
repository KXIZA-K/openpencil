...
pub struct EditorUiState {
    ...
    /// Text, caret, selection, and blink state of the model-picker search.
    pub chat_model_picker_input: jian_core::text_input::TextInputState,
    /// UI-only conversation selector; durable contents live in `ChatSessions`.
    ...
    /// Hovered design card `(message_index, block_index)` for copy reveal.
