...
impl CanvasKitBackend {
    /// Share browser font metrics with embedded preview runtimes.
    pub fn preview_measure(&self) -> std::rc::Rc<dyn jian_core::layout::measure::MeasureBackend> {
        std::rc::Rc::new(super::measure::BrowserMeasure::new(&self.ck))
    }
}
